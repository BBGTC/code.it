 ...
 */ function createReactQueryUtilsProxy(context) {
    ...
    // noop
        ...
        get (_obj, name) {
            ...
            return shared.createProxy(({ path , args  })=>{
                const pathCopy = [
                    name,
                    ...path
                ];
 ...
 */ function createHooksInternal() {
    ...
    const TRPCProvider = (props)=>{
        ...
        return /*#__PURE__*/ React__default["default"].createElement(Context.Provider, {
            value: {
                ...
                invalidateQueries: React.useCallback((...args)=>queryClient.invalidateQueries(...args), [
                    queryClient
                ]),
                refetchQueries: React.useCallback((...args)=>queryClient.refetchQueries(...args), [
                    queryClient
                ]),
                ...
                setQueryData: React.useCallback((...args)=>queryClient.setQueryData(...args), [
                    queryClient
                ]),
                getQueryData: React.useCallback((...args)=>queryClient.getQueryData(...args), [
                    queryClient
                ]),
                ...
                getInfiniteQueryData: React.useCallback((...args)=>queryClient.getQueryData(...args), [
                    queryClient
                ])
            }
        }, props.children);
   ...
   */ function useSSRQueryOptionsIfNeeded(pathAndInput, opts) {
    ...
    function useQuery(pathAndInput, opts) {
        ...
        return reactQuery.useQuery(pathAndInput, (queryFunctionContext)=>{
            const actualOpts = {
                ...ssrOpts,
                trpc: {
                    ...ssrOpts?.trpc,
    ...
    function useMutation(path, opts) {
        ...
        return reactQuery.useMutation((input)=>{
   ...
   */ function useSubscription(pathAndInput, opts) {
    ...
    function useInfiniteQuery(pathAndInput, opts) {
        ...
        // request option should take priority over global
        const shouldAbortOnUnmount = opts?.trpc?.abortOnUnmount ?? abortOnUnmount;
        return reactQuery.useInfiniteQuery(pathAndInput, (queryFunctionContext)=>{
            const actualOpts = {
                ...ssrOpts,
                trpc: {
                    ...ssrOpts?.trpc,
