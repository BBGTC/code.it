...
import { c as createProxy } from './index-5b2e87d4.mjs';
 ...
 */ function createRouterFactory(defaults) {
    return function createRouterInner(opts) {
        const reservedWordsUsed = new Set(Object.keys(opts).filter((v)=>reservedWords.includes(v)));
...
export { defaultTransformer as a, assertNotBrowser as b, createRouterFactory as c, defaultFormatter as d, callProcedure as e, getHTTPStatusCodeFromError as f, getDataTransformer as g, mergeWithoutOverrides as m, procedureTypes as p, resolveHTTPResponse as r };
